...
public class TNLNamespace
{
    ...
    public static final String[] ADD_ARGS = new String[]{ "+", TNLNamespace.TERM };
    ...
    public static final String[] SUBTRACT_ARGS = new String[]{ TNLNamespace.MINUEND, "+", TNLNamespace.SUBTRAHEND };

	public static final String MULTIPLY = TN_NS+"Multiply";
	public static final String FACTOR   = TN_NS+"factor";
    public static final String[] MULTIPLY_ARGS = new String[]{ "+", TNLNamespace.FACTOR };
    ...
    public static final String[] DIVIDE_ARGS = new String[]{ TNLNamespace.DIVIDEND, "+", TNLNamespace.DIVISOR };
